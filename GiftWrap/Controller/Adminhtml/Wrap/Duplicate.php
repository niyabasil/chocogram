...
class Duplicate extends Action
{
    ...
    public function execute()
    {
        ...
        if ($wrapId) {
            try {
                $this->wrapRepository->duplicate($wrapId);
                $this->messageManager->addSuccessMessage(__('The wrap have been duplicated.'));
                ...
                $this->messageManager->addErrorMessage(
                    __('Can\'t duplicate wrap right now. Please review the log and try again.')
                );
